...
let
  ...
  py = python3.override {
    packageOverrides = self: super: {
      ...
      azure-mgmt-advisor =
        overrideAzureMgmtPackage super.azure-mgmt-advisor "9.0.0" "zip"
          "sha256-/ECLNzFf6EeBtRkST4yxuKwQsvQkHkOdDT4l/WyhjXs=";
      azure-mgmt-apimanagement =
        overrideAzureMgmtPackage super.azure-mgmt-apimanagement "4.0.0" "zip"
          "sha256-AiTjLJ28g80xnrRFLfPUevJgeaxLpuGmvkd3+FskNiw=";
      azure-mgmt-authorization =
        overrideAzureMgmtPackage super.azure-mgmt-authorization "4.0.0" "zip"
          "sha256-abhavAmuZPxyl1vUNDEXDYx+tdFmdUuYqsXzhF3lfcQ=";
      azure-mgmt-billing =
      ...
      azure-mgmt-cognitiveservices =
        overrideAzureMgmtPackage super.azure-mgmt-cognitiveservices "13.5.0" "zip"
          "sha256-RK8LGbH4J+nN6gnGBUweZgkqUcMrwe9aVtvZtAvFeBU=";
      azure-mgmt-compute =
        overrideAzureMgmtPackage super.azure-mgmt-compute "30.4.0" "tar.gz"
          "sha256-C3Qo/YvRXHy9fGa5uwEOClyzeoBs7x9JSNkHGRV2kzQ=";
      azure-mgmt-containerinstance =
        overrideAzureMgmtPackage super.azure-mgmt-containerinstance "10.1.0" "zip"
          "sha256-eNQ3rbKFdPRIyDjtXwH5ztN4GWCYBh3rWdn3AxcEwX4=";
      azure-mgmt-containerregistry =
        overrideAzureMgmtPackage super.azure-mgmt-containerregistry "10.1.0" "zip"
      ...
      azure-mgmt-cosmosdb =
        overrideAzureMgmtPackage super.azure-mgmt-cosmosdb "9.3.0" "tar.gz"
          "sha256-02DisUN2/auBDhPgE9aUvEvYwoQUQC4NYGD/PQZOl/Y=";
      azure-mgmt-databoxedge =
        overrideAzureMgmtPackage super.azure-mgmt-databoxedge "1.0.0" "zip"
          "sha256-BAkAYrwejwDC9FMVo7zrD7OzR57BR01xuINC4TSZsIc=";
      azure-mgmt-datalake-nspkg =
        overrideAzureMgmtPackage super.azure-mgmt-datalake-nspkg "3.0.1" "zip"
          "sha256-3rGSukIviz7Ccs5OiHNnlvIW8o6lsD8oMx14S3o/SIA=";
      azure-mgmt-datamigration =
        overrideAzureMgmtPackage super.azure-mgmt-datamigration "10.0.0" "zip"
      ...
      azure-mgmt-hdinsight =
        overrideAzureMgmtPackage super.azure-mgmt-hdinsight "9.0.0" "zip"
          "sha256-QevcacDR+B0l3TBDjBT/9DMfZmOfVYBbkYuWSer/54o=";
      azure-mgmt-imagebuilder =
        overrideAzureMgmtPackage super.azure-mgmt-imagebuilder "1.2.0" "zip"
      ...
      azure-mgmt-managementgroups =
        overrideAzureMgmtPackage super.azure-mgmt-managementgroups "1.0.0" "zip"
      ...
      azure-mgmt-msi =
        overrideAzureMgmtPackage super.azure-mgmt-msi "7.0.0" "zip"
          "sha256-ctRsmmJ4PsTqthm+nRt4/+u9qhZNQG/TA/FjA/NyVrI=";
      ...
      azure-mgmt-recoveryservices =
        overrideAzureMgmtPackage super.azure-mgmt-recoveryservices "2.5.0" "tar.gz"
          "sha256-XxowjEhYx5uD/4vY5hGSCSvcarmdbdc5Y2GLHciEurU=";
      azure-mgmt-recoveryservicesbackup =
        overrideAzureMgmtPackage super.azure-mgmt-recoveryservicesbackup "7.0.0" "tar.gz"
          "sha256-GuW6x8JGdBedywum4fDAQ8rwbVU9UgQWgHrFqJ6Uz9A=";
      azure-mgmt-redhatopenshift =
        overrideAzureMgmtPackage super.azure-mgmt-redhatopenshift "1.4.0" "tar.gz"
          "sha256-BL2a2L2AwJWvs0V+VpSGaS8//AWMy5m6rdAPDJPbrEo=";
      azure-mgmt-redis =
        overrideAzureMgmtPackage super.azure-mgmt-redis "14.1.0" "zip"
      ...
      azure-mgmt-security =
        overrideAzureMgmtPackage super.azure-mgmt-security "5.0.0" "zip"
          "sha256-OLA+/oLCNEzqID/alebQC3rCJ4L6HAtYXNDqLI/z5wI=";
      azure-mgmt-servicebus =
        overrideAzureMgmtPackage super.azure-mgmt-servicebus "8.2.0" "zip"
          "sha256-i+kgjxQdmnifaNuNIZdU/3gGn9j5OQ6fdkS7laO+nsI=";
      azure-mgmt-servicefabricmanagedclusters =
        overrideAzureMgmtPackage super.azure-mgmt-servicefabricmanagedclusters "1.0.0" "zip"
          "sha256-EJyjolHrt92zWg+IKWFKTapwZaFrwTtSyEIu5/mZXOg=";
      azure-mgmt-storage =
        overrideAzureMgmtPackage super.azure-mgmt-storage "21.1.0" "tar.gz"
          "sha256-1tPA6RfJiLye0Eckd9PvP5CIYAnrHZenEZRPg3VjAWI=";
      ...
      azure-synapse-managedprivateendpoints =
        overrideAzureMgmtPackage super.azure-synapse-managedprivateendpoints "0.4.0" "zip"
          "sha256-kA6urM/9zQEBKySKfQSQCMkoB7dJ7dHJB0ypJIVUwX4=";
      ...
      azure-mgmt-appcontainers =
        overrideAzureMgmtPackage super.azure-mgmt-appcontainers "2.0.0" "zip"
          "sha256-ccdIdvdgTYPWEZCWqkLc8lEuMuAEERvl5B1huJyBkvU=";

      azure-mgmt-batch =
        (overrideAzureMgmtPackage super.azure-mgmt-batch "17.0.0" "zip"
      ...
      azure-mgmt-rdbms =
        overrideAzureMgmtPackage super.azure-mgmt-rdbms "10.2.0b11" "tar.gz"
          "sha256-A7SwklqAhz4Ey9ar1YWythtVZyQ2Y2RUsa27iMc2mxU=";

      azure-mgmt-appconfiguration =
        overrideAzureMgmtPackage super.azure-mgmt-appconfiguration "3.0.0" "zip"
      ...
      azure-mgmt-iothub =
        overrideAzureMgmtPackage super.azure-mgmt-iothub "3.0.0" "tar.gz"
      ...
      azure-mgmt-loganalytics =
        overrideAzureMgmtPackage super.azure-mgmt-loganalytics "13.0.0b4" "zip"
      ...
      azure-mgmt-web =
        overrideAzureMgmtPackage super.azure-mgmt-web "7.2.0" "tar.gz"
      ...
      azure-mgmt-sql =
        overrideAzureMgmtPackage super.azure-mgmt-sql "4.0.0b12" "tar.gz"
      ...
      azure-mgmt-keyvault =
        overrideAzureMgmtPackage super.azure-mgmt-keyvault "10.3.0" "tar.gz"
      ...
      azure-mgmt-servicefabric =
        (overrideAzureMgmtPackage super.azure-mgmt-servicefabric "1.0.0" "zip"
      ...
      azure-mgmt-servicelinker =
        overrideAzureMgmtPackage super.azure-mgmt-servicelinker "1.2.0b1" "zip"
      ...
      azure-mgmt-resource =
        overrideAzureMgmtPackage super.azure-mgmt-resource "23.1.0b2" "zip"
