  ...
  ((callFile ./common/builder.nix { }) (
    {
      ...
      inherit noSysDirs staticCompiler withoutTargetLibc libcCross crossMingw;
      ...
      env = mapAttrs (_: v: toString v) (
        ...
        // optionalAttrs is7 {
          NIX_CFLAGS_COMPILE =
            lib.optionalString (stdenv.cc.isClang && langFortran) "-Wno-unused-command-line-argument"
      ...
      passthru = {
        ...
        hardeningUnsupportedFlags =
          lib.optional is48 "stackprotector"
          ++ lib.optional (!atLeast11) "zerocallusedregs"
          ++ lib.optionals (!atLeast12) [
            "fortify3"
            "trivialautovarinit"
          ]
