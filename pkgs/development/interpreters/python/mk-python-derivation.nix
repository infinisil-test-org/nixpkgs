...
let
  ...
  isBootstrapPackage =
    ...
    || builtins.elem (attrs.pname or null) (
      [
        "build"
        "packaging"
        "pyproject-hooks"
  ...
  passthru =
    ...
    // lib.optionalAttrs (dependencies != [ ]) { inherit dependencies; }
    // lib.optionalAttrs (optional-dependencies != { }) { inherit optional-dependencies; }
    // lib.optionalAttrs (build-system != [ ]) { inherit build-system; };
