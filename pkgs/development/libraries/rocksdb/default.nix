...
stdenv.mkDerivation (finalAttrs: {
  ...
  env.NIX_CFLAGS_COMPILE = toString (
    ...
    ++ lib.optionals (lib.versionOlder finalAttrs.version "8") [ "-Wno-error=unused-but-set-variable" ]
    ++ lib.optionals (lib.versionOlder finalAttrs.version "7") [ "-Wno-error=deprecated-copy" ]
  );
