...
[
  ...
  (
    ...
    stageFun prevStage {
      ...
      overrides = self: super: {
        inherit (prevStage) ccWrapperStdenv coreutils gnugrep;
        ...
        llvmPackages =
          ...
          // (
            let
              ...
              libraries = super.llvmPackages.libraries.extend (
                _: _: { inherit (prevStage.llvmPackages) compiler-rt libcxx libcxxabi; }
              );
            in
            {
            ...
            let
              ...
              libraries = super.llvmPackages.libraries.extend (
                selfLib: superLib: {
                  ...
                  libcxxabi =
                    superLib.libcxxabi.override { stdenv = libcxxBootstrapStdenv; }
                    ...
                    // lib.optionalAttrs (builtins.any (v: llvmMajor == v) [
                      "7"
                      "11"
                      "12"
                      "13"
  ...
  (
    ...
    stageFun prevStage {
      ...
      overrides = self: super: {
        ...
        cpio = super.cpio.override { inherit (prevStage) fetchurl; };

        libyaml = super.libyaml.override { inherit (prevStage) fetchFromGitHub; };

        pbzx = super.pbzx.override { inherit (prevStage) fetchFromGitHub; };

        python3Minimal = super.python3Minimal.override { inherit (prevStage) fetchurl; };

        xar = super.xar.override { inherit (prevStage) fetchurl; };
        ...
        darwin = super.darwin.overrideScope (
          selfDarwin: superDarwin: {
            ...
            rewrite-tbd = superDarwin.rewrite-tbd.override { inherit (prevStage) fetchFromGitHub; };
