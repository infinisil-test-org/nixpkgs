...
self: super: with self; {
  ...
  cot = callPackage ../development/python-modules/cot { qemu = pkgs.qemu; };
  ...
  onnx = callPackage ../development/python-modules/onnx { abseil-cpp = pkgs.abseil-cpp_202301; };
  ...
  pendulum =
    if pythonAtLeast "3.12" then pendulum_3 else callPackage ../development/python-modules/pendulum { };
