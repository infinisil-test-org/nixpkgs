...
let
  ...
  jobs = recursiveUpdateMany [
    ...
    (versionedCompilerJobs {
      ...
      # working as expected.
      cabal-install = lib.subtractLists [ compilerNames.ghc981 ] released;
      Cabal_3_10_2_1 = lib.subtractLists [ compilerNames.ghc981 ] released;
      Cabal-syntax_3_10_1_0 = lib.subtractLists [ compilerNames.ghc981 ] released;
      cabal2nix = lib.subtractLists [ compilerNames.ghc981 ] released;
      cabal2nix-unstable = lib.subtractLists [ compilerNames.ghc981 ] released;
      funcmp = released;
      ...
      hpack = lib.subtractLists [ compilerNames.ghc981 ] released;
      hsdns = released;
      jailbreak-cabal = released;
      language-nix = lib.subtractLists [ compilerNames.ghc981 ] released;
      large-hashable = [ compilerNames.ghc928 ];
      nix-paths = released;
      titlecase = lib.subtractLists [ compilerNames.ghc981 ] released;
      ghc-api-compat = [
        compilerNames.ghc8107
        compilerNames.ghc902
      ];
      ghc-bignum = [ compilerNames.ghc8107 ];
      ghc-lib = lib.subtractLists [ compilerNames.ghc981 ] released;
      ghc-lib-parser = lib.subtractLists [ compilerNames.ghc981 ] released;
      ghc-lib-parser-ex = lib.subtractLists [ compilerNames.ghc981 ] released;
      ghc-source-gen = [
      ...
      ghc-tags = lib.subtractLists [ compilerNames.ghc981 ] released;
      hashable = lib.subtractLists [ compilerNames.ghc981 ] released;
      primitive = released;
      weeder = [
        compilerNames.ghc8107
        compilerNames.ghc902
