      ...
      final =
        {
          ...
          libDir =
            if final.isLinux then
              ...
              null;
          extensions =
            lib.optionalAttrs final.hasSharedLibraries {
              sharedLibrary =
                if final.isDarwin then
                  ".dylib"
          ...
          qemuArch =
            if final.isAarch32 then
              ...
              "mipsn32${lib.optionalString final.isLittleEndian "el"}"
            else if final.isMips64 then
          ...
          rust = rust // {
            ...
            platform = rust.platform or { } // {
              ...
              target-family =
                if args ? rust.platform.target-family then
                  ...
                  lib.optional final.isUnix "unix" ++ lib.optional final.isWindows "windows";
            ...
            rustcTargetSpec =
              rust.rustcTargetSpec or (
                if rust ? platform then
                  builtins.toFile (final.rust.rustcTarget + ".json") (builtins.toJSON rust.platform)
                else
            ...
            cargoShortTarget = lib.removeSuffix ".json" (baseNameOf "${final.rust.rustcTargetSpec}");
            ...
            cargoEnvVarTarget = lib.strings.replaceStrings [ "-" ] [ "_" ] (
              lib.strings.toUpper final.rust.cargoShortTarget
            );

            # True if the target is no_std
            # https://github.com/rust-lang/rust/blob/2e44c17c12cec45b6a682b1e53a04ac5b5fcc9d2/src/bootstrap/config.rs#L415-L421
            isNoStdTarget = builtins.any (t: lib.hasInfix t final.rust.rustcTarget) [
              "-none"
              "nvptx"
              "switch"
              "-uefi"
